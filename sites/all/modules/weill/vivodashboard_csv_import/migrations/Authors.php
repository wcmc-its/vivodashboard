...
class VivoDashboardAuthorsMigration extends VivoDashboardCsvMigrationBase {
  ...
  public static $migrationArguments = array(
    ...
    'csv_columns' => array(
      ...
      7 => array('types', 'RDF Types'),
        8 => array('popsuri', 'POPS URI'),
        9 => array('webdiruri', 'WEBDIR URI'),
        10 => array('vivouri', 'VIVO URI'),
        11 => array('primary_title', 'Primary Title')
    ),
  );
  ...
  public function __construct($arguments) {
    ...
    $this->addFieldMapping('field_rdf_type:source_type')->defaultValue('tid');
      $this->addFieldMapping('field_popsuri', 'popsuri');
      $this->addFieldMapping('field_webdiruri', 'webdiruri');
      $this->addFieldMapping('field_vivouri', 'vivouri');
      $this->addFieldMapping('field_primary_title', 'primary_title');
  }
