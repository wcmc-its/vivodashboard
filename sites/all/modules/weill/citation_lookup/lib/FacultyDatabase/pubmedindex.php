...
<head>
	...
	<title>AnyStyle.IO PubMed Database Mapper</title>
...
<div id="wrap">
<h1><a href="">AnyStyle.IO PubMed Database Mapper</a></h1>
<p><strong>Copyright @2015 by </strong>: <a href="https://github.com/asifr">WCMC</a></p>

<p>This application is to extract information form PubMed Database. It uses the PubMedAPI class to query PubMed and return the results in a table.</p>

<form action='' method="get" accept-charset="utf-8">
	<p><label for="search_term">Search Citations: </label> <input type="text" name="term" value="<?php echo isset($_GET['term'])?stripslashes($_GET['term']):''; ?>" id="search_term"> <input type="submit" value="Search PubMed"></p>
</form>
...
if (isset($_GET['term']) && $_GET['term'] != '') {
	...
	if (isset($_GET['page'])) {
        ...
        $results = $PubMedAPI->query($result);
}
?>
