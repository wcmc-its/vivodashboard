<?php
/************************************************************************************************
 * // Name:    scopus_fetch_parallel.php
 * // Author:    Prakash Adekkanattu
 * // Date:    08/05/16
 * // Description:    Fetch citation count from scopus run in parallel
 ************************************************************************************************/
...
$manager->processes = 11;                        //max concurrent processes
$manager->sleep_time = 20;                        //time between checking if the processes are complete
...
foreach ($pub_years as $year) {
    $manager->addScript("scopus.php", $year, 3600);
}
