    ...
    Drupal.behaviors.citations = { attach: function (select, settings) {
        ...
        function drawBlock(axisGroup, blockGroup, articles, lowerBound, upperBound, percentileMedian, timePeriodIndex, width, height) {
            ...
            var tiles = tileGroup.selectAll(".tile")
                ...
                .enter()
                .append("rect")
                .attr("id", function(d) { return "article_" + d[0].pmid; })
                ...
                .on("click", function(d) { showArticleCallout('#article_' + d[0].pmid, d, articles); })
            ...
            var articles =
                _.map(
                    ...
                    _.sortBy(
                        ...
                        _.filter(unprocessedData, function(d) {return d.pmid == article.pmid;}),
                        'percentile_rank'
                    ),
                    function(d) {
