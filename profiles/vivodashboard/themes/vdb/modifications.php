...
function vdb_page_alter(&$page) {
  drupal_add_css('https://fonts.googleapis.com/css?family=Open+Sans:400,400italic,600,700,700italic', array('type' => 'external'));
}
 ...
 */
function vdb_facetapi_count($variables) {
  return '(' . number_format($variables['count']) . ')';
}
