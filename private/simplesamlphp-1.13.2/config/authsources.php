...
// Figure out which IdP to use; default to prod
//$idp = 'https://shib.med.cornell.edu/idp/shibboleth';
//
//if (isset($_SERVER['HTTP_HOST'])) {
//    // Change to dev if not the live environment.
//
//    if ($_SERVER['HTTP_HOST'] !== 'http://live-vivo-dashboard.gotpantheon.com') {
//        $idp = 'https://shibdev.med.cornell.edu/idp/shibboleth';
//    }
//}



$idp = 'https://login.weill.cornell.edu/idp';
if (isset($_SERVER['PANTHEON_ENVIRONMENT'])) {
    // Change to dev if not the live environment.
    if ($_SERVER['PANTHEON_ENVIRONMENT'] !== 'live') {
        $idp = 'https://login-test.weill.cornell.edu/idp';
    }
}
...
$config = array(
    ...
    'default-sp' => array(
        ...
        'entityID' => 'https://vivo-dashboard.weill.cornell.edu/sp',
